...
class HealthIcon extends FlxSprite
{
	...
	public function new(char:String = 'face', isPlayer:Bool = false, ?_id:Int = -1)
	{
		...
		if(Config.betterIcons){
			...
			loadGraphic('assets/images/iconGridPLUS.png', true, 150, 150);
			...
			animation.add('senpai', [0, 1], 0, false, isPlayer);
			animation.add('senpai-angry', [0, 1], 0, false, isPlayer);
			animation.add('spirit', [0, 1], 0, false, isPlayer);
			animation.add('bf-old', [1, 0], 0, false, isPlayer);
			animation.add('gf', [0], 0, false, isPlayer);
			animation.add('gf-car', [0], 0, false, isPlayer);
			animation.add('gf-pixel', [0], 0, false, isPlayer);
